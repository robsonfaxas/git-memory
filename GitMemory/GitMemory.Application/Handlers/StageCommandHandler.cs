...
{
    public class StageCommandHandler : IRequestHandler<StageCommand, Command>
    {
        ...
        public async Task<Command> Handle(StageCommand request, CancellationToken cancellationToken)
        {
